        ...
        >
            <div className="relative bg-gray-100 overflow-hidden rounded-t-xl group-hover:scale-105 transition-transform duration-500" style={{ height: `${cardHeight * 0.48}px`, minHeight: `${cardHeight * 0.48}px` }}>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/80 to-transparent">
                    <Link href={`/Doctors/${doctor.id}`} className="text-white text-lg font-semibold font-montserrat truncate hover:underline" aria-label={`View profile of ${doctor.doctor_name}`}>
                        {doctor.doctor_name}
                    </Link>
                </div>
            </div>
            <div className="p-4 flex flex-col flex-grow" style={{ height: `${cardHeight * 0.52}px`, minHeight: `${cardHeight * 0.52}px` }}>
                ...
                <Link href={`/booking?doctorId=${doctor.id}`} className="mt-auto block bg-[#005543dd] text-white py-2 rounded-lg font-semibold text-center hover:bg-[#004a3a] transition" aria-label={`Book appointment with ${doctor.doctor_name}`}>
                    Book Now
                </Link>
            </div>
        </article>
