        ...
        <div className="relative z-10 w-full max-w-sm sm:mr-16 sm:ml-auto mx-auto bg-green-100 bg-opacity-20 backdrop-blur rounded-xl shadow-lg p-6 my-auto flex flex-col justify-center items-center">
          ...
          <form action={action}>
            <input
              ...
              placeholder="Email"
              className="w-full px-4 py-2 mb-4 placeholder:text-gray-600 bg-white bg-opacity-40 border border-gray-200 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-400"
            />
