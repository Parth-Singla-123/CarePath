...
const Footer = () => {
  return (
    <footer className="bg-green-900 text-green-100 pt-12 pb-8 px-6 sm:px-10 md:px-16 font-sans select-none">
          ...
          <div className="flex gap-6">
            <Link href="https://instagram.com" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
              <svg
                aria-hidden="true"
                focusable="false"
                className="w-6 h-6 fill-green-400 hover:fill-white transition-colors duration-300"
                viewBox="0 0 24 24"
              >
      ...
      {/* Bottom Section */}
      <div className="mt-10 border-t border-green-700 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-green-400">
        <CarePathLogo className="mb-4 md:mb-0" />
